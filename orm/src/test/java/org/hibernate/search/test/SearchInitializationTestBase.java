 ...
 * <p>When subclassing this class, Hibernate Search's initialization must be triggered manually by calling
...
public abstract class SearchInitializationTestBase {
	...
	/**
	 * @return the testResourceManager, or null there isn't any (i.e. if {@link #init(TestConfiguration)}
