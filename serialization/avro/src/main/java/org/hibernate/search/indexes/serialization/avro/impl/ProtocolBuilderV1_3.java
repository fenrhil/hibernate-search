...
/**
 * Helper to build an Avro Protocol version 1.3 from all our resource
 * schemas.
 */
class ProtocolBuilderV1_3 extends ProtocolBuilderV1_1 {

	private static String V1_3_PATH = "org/hibernate/search/remote/codex/avro/v1_3/";

	/**
	 * @return an Avro Protocol at version 1.3
	 */
	@Override
	Protocol build() {
