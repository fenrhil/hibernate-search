...
public enum IndexSchemaManagementStrategy {
	...
	/**
	 * Indexes will never be created or deleted. The index schema is not managed by Hibernate Search and is never checked.
	 */
	NONE,
	 ...
	 * This strategy will never bring any change to the mappings, nor create or delete any index.
	 */
	VALIDATE,
