...
import static org.hibernate.search.elasticsearch.testutil.ExceptionMatcherBuilder.isException;
...
public class ElasticsearchSchemaValidationIT extends SearchInitializationTestBase {
	...
	private static final String MISSING_MAPPING_MESSAGE_ID = "HSEARCH400035";
	private static final String INVALID_MAPPING_MESSAGE_ID = "HSEARCH400036";
	...
	private void assertSuccessfulInitialization() {
		/*
		 * If we manage to get a session, we assume initialization worked fine.
		 * This check is not strictly required, since a failing initialization should
		 * normally throw exceptions before this assertion anyway.
		 */
		try (Session s = getTestResourceManager().openSession()) {
